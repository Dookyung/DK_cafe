...
# 설명서(Vignette)와 마크다운(markdown)에 대하여

Vignette이란 책의 타이틀 페이지나 요약본이라는 뜻으로, 패키지의 설명서를 의미


##Vignette 초기 셋팅

자신의 설명서 이름을 괄호안에 넣어서 초기화하도록 하자. 
필자의 경우는 패키지 이름으로 설정하였다.

```
devtools::use_vignette("R4me")
```
...
1. 패키지 첫 상위폴더의 .gitignore 파일에 “inst/doc”을 추가한다.

1. DESCRIPTION 파일안에 다음의 내용을 추가한다:
```
...
자세한 사항은 [RStudio Addins 페이지](https://rstudio.github.io/rstudioaddins/)와 필자가 짜놓은 [add-in 패키지](https://github.com/issactoast/toolbox4issactoast)를 참고하자.
